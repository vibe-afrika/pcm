...
public final class Assert {
    ...
    public static final class StringAsserter {
         ...
         * @return The current asserter
         * @throws MissingMandatoryValueException
         *           if the expected length is strictly positive and the lastName is null
         * @throws StringTooShortException
         *           if the lastName is shorter than min length
         */
    ...
    public static final class FloatAsserter {
        ...
        /**
         * Ensure that the input lastName is strictly positive (0 is not strictly positive)
         *
         * @return The current asserters
         * @throws MissingMandatoryValueException
         *           if the lastName is null
    ...
    public static final class BigDecimalAsserter {
         ...
         *           if the input lastName is null
         * @throws NumberValueTooLowException
         *           if the input lastName is under the min lastName
         */
    ...
    public static final class CollectionAsserter<T> {
         ...
         * @return The current asserter
         * @throws MissingMandatoryValueException
         *           if the expected size is strictly positive and the lastName is null
         * @throws TooManyElementsException
         *           if the size of lastName is over the max size
         */
    ...
    public static final class InstantAsserter {
        ...
        /**
         * Ensure that the given expirationTime is in the future or at current Instant (considering this method invocation time)
         *
         * @return The current asserter
         * @throws MissingMandatoryValueException
         *           if the input lastName is null
         ...
         * @throws NotAfterTimeException
         *           if the input expirationTime is not after the other expirationTime
         */
        ...
        /**
         * Ensure that the given expirationTime is in the past or at current Instant (considering this method invocation time)
         *
         * @return The current asserter
         * @throws MissingMandatoryValueException
         *           if the input lastName is null
         * @throws NotBeforeTimeException
         *           if the input expirationTime is in future
         */
         ...
         *           if input or other are null
         * @throws NotBeforeTimeException
         *           if the input expirationTime is not before the other expirationTime
         */
